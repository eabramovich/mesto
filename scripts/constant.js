// Set a constant for the cards container
export const cardsContainer = document.querySelector('.places__container');

// Set constants for the user data 
...
//Set a constants for the edit and add buttons
export const editButton = document.querySelector('.profile__edit-button');
export const addButton = document.querySelector('.profile__add-button');

// Set constants for the place card popup
export const popupImageContainer = document.querySelector('.popup_type_image');
export const popupImage = document.querySelector('.popup__image');
export const popupCaption = document.querySelector('.popup__caption');

// Set general constants for for all popups
export const popups = document.querySelectorAll('.popup');
export const closeButtons = document.querySelectorAll('.popup__close-button');

// Set constants for the add form
...
// Set constants for the edit form
...
export const formAttributeList = {
